...
const ASSETS = ["./","./index.html","./version.js","./proj4.js","./australia-map.js","./manifest.webmanifest","./icons/favicon-32.png","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png"];
